...
public class TestWebAuthn
{
    ...
    public void test()
    {
        ...
        String webauthnSignResponse =
                "{\"credentialid\":\"kJCeTZ-AtzwuuF-BkzBNO_0-e4bkf8IVaqzjO4lkVjwNyLmOx9tHwO-BKwYxgitd4uoowT43EGm_x3mNhT1i-w\"," +
        ...
        PIResponse response = privacyIDEA.validateCheckWebAuthn(username, "16786665691788289392", webauthnSignResponse,
                                                                "origin");
