...
public class TestGetTokenInfo implements IPILogger {
    ...
    public void test() {
        ...
        String result = "{\"id\":1," +
                        ...
                        "\"hashlib\":\"sha1\"," +
                        "\"last_auth\":\"2022-03-2912:18:59.639421+02:00\"," +
                        "\"tokenkind\":\"software\"}," +
                        "\"locked\":false," +
                        "\"maxfail\":10," +
                        "\"otplen\":6," +
                        ...
                        "\"user_realm\":\"defrealm\"," +
                        "\"username\":\"Test\"}]}}," +
                        "\"time\":1648549489.57896," +
                        "\"version\":\"privacyIDEA3.6.3\"," +
                        "\"versionnumber\":\"3.6.3\"," +
                        "\"signature\":\"rsa_sha256_pss:58c4eed1...5247c47e3e\"}";

        String resultNoTokens = "{\"id\":1," +
                                "\"jsonrpc\":\"2.0\"," +
                                "\"result\":{" +
                                "\"status\":true," +
                                "\"value\":{" +
    ...
    //todo add new test with no token (see above)
